module github.com/kcp-dev/multicluster-provider/cmd/kcp-endpointslice-watcher

go 1.26.3

replace github.com/kcp-dev/multicluster-provider => ../..
...
require (
	...
	github.com/kcp-dev/apimachinery/v2 v2.31.2-0.20260505083940-abda469632ba // indirect
