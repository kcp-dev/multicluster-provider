...
const (
	...
	AssetsDefaultPath = "/usr/local/kcp/bin"
)
...
// 1. TEST_KCP_ASSETS (if set; global asset path -- EnvAssetsPath)
// 3. assetDirectory (if set; per-config asset directory)
// 4. /usr/local/kcp/bin (AssetsDefaultPath).
